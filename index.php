...
<body>
  <header class="clearfix" data-ng-include="'/content/header.html'"></header>
  <nav data-ng-include="'/content/nav.html'"></nav>
  <main data-ng-view></main>
  <footer data-ng-include="'/content/footer.html'"></footer>
...
<section id="projects">
  <div class="content">
    ...
    <h3>AllMyDrawings</h3>
    <div class="project">
    <a href="http://allmydrawings.com"><img src="files/allmydrawings.png" alt="AllMyDrawings"></a>
    <div>
    <div><a href="http://allmydrawings.com">allmydrawings.com</a></div>
    <p>
    A personal project. In some sense, a public marathon/challenge, where I'm trying
    to learn drawing from the very beginning.
    </p>
    </div>
    <div class="clearfix"></div>
    </div>
...
<section id="workedwith">
  <div class="content">
    <h2>Worked with</h2>
    <img src="/files/logos/timendime.png" alt="TimeNDime" title="TimeNDime" />
    <img src="/files/logos/widny.png" alt="Women In Development" title="Women In Development" />
    <img src="/files/logos/3redsquares.jpg" alt="3 Red Squares" title="3 Red Squares" />
    <img src="/files/logos/macroactive.png" alt="MacroActive" title="MacroActive" />
    <img src="/files/logos/buildingmuscle101.png" alt="Building Muscle 101" title="Building Muscle 101" />
    <img src="/files/logos/inspire.png" alt="Inspire" title="Inspire" />
    <img src="/files/logos/massimoamici.png" alt="Massimo Amici" title="Massimo Amici" />
    <img src="/files/logos/acalumafilms.png" alt="Acaluma Films" title="Acaluma Films" />
    <img src="/files/logos/friedcrickets.gif" alt="FriedCrickets" title="FriedCrickets" />
    <img src="/files/logos/jasonoddy.png" alt="Jason Oddy" title="Jason Oddy" />
    <img src="/files/logos/beltwaytothebay.png" alt="Beltway To The Bay" title="Beltway To The Bay" />
    <img src="/files/logos/made4maids.png" alt="Made 4 Maids" title="Made 4 Maids" />
    <div class="justify"></div>
    <p>...and dozens more.</p>
    <div class="totop"></div>
  </div>
...
Vitaly was very flexible and willing to try different things until I was happy. Great guy.
  ...
  <div class="content">
    <h2>Contact</h2>
    <form method="POST">
     <input type="hidden" name="protection">
